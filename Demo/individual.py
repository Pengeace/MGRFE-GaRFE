...
Each individual represents a gene combination and the related classification metrics and information of this combination.
...
class Individual(object):
    index_gap = 0.009             # adjust rankings for individuals having similar fitness and gene combination size values
    ...
    def __init__(self,index=0):
        ...
        self.metrics = []         # a list of the classification metrcis, the elements in it can be arbitrarily specified
