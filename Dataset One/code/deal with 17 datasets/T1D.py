# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset T1D.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\T1D.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "uh"                        # the name of positive samples in the data set file
neg_name = "td"                        # the name of negative samples in the data set file
