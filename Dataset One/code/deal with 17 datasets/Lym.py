# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset Lymphoma.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\Lymphoma.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "ACL"                        # the name of positive samples in the data set file
neg_name = "GCL"                        # the name of negative samples in the data set file
