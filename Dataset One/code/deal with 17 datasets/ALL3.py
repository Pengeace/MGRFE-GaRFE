# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset ALL3.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\ALL3.txt"
...
ft_index_name = 'mdr'               # the index name of the probe ID column
...
rfe_numbers = [3,2,3,1]     # GaRFE numbers in every layer
...
for l in range(Total_layer):
    ...
    for rfe_num in range(rfe_numbers[l]):
        rfe = RFE(dataset=dataset_name, initial_ft_rg=ft_rg_layer[l],
                  ...
                  pop_best_size=10,pop_size=100,best_size=30)
        rfe.down()
