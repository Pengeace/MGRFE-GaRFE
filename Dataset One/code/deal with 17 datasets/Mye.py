# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset Myeloma.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\Myeloma.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "TRUE"                                           # the name of positive samples in the data set file
neg_name = "FALSE"                                          # the name of negative samples in the data set file
ft_index_name = 'Presence_of_bone_lesions'                  # the index name of the probe ID column
...
feature_numbers_layer = [700,100,30,20]     # the size of candidate gene set in every layer
...
for l in range(Total_layer):
    ...
    for rfe_num in range(rfe_numbers[l]):
        rfe = RFE(dataset=dataset_name, initial_ft_rg=ft_rg_layer[l],
                  ...
                  pop_best_size=10,pop_size=90,best_size=20)
        rfe.down()
