# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset Gastric.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\Gastric.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "non-malignant"                        # the name of positive samples in the data set file
neg_name = "tumor"                        # the name of negative samples in the data set file
