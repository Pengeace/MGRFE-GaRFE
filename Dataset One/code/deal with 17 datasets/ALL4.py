# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset ALL4.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\ALL4.txt"
...
ft_index_name = 'chr'                   # the index name of the probe ID column
