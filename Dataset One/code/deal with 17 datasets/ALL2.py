# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset ALL2.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\ALL2.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "FALSE"                   # the name of positive samples in the data set file
neg_name = "TRUE"                    # the name of negative samples in the data set file
ft_index_name = 'relapse'            # the index name of the probe ID column
