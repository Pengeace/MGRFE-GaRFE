# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset DLBCL.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\DLBCL.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "DLBCL"                                  # the name of positive samples in the data set file
neg_name = "follicular_lymphoma"                    # the name of negative samples in the data set file
