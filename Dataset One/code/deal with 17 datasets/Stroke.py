# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset Stroke.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\Stroke.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "CTRL"                   # the name of positive samples in the data set file
neg_name = "IS"                     # the name of negative samples in the data set file
ft_index_name = 'Probe_Set_ID'      # the index name of the probe ID column
