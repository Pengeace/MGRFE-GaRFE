# -*- coding: utf-8 -*-
"""
This script is for dealing with the dataset Colon.
...
file_path = "D:\\codes\\python\\MGRFE\\Dataset One\\data\\Colon.txt"
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\"+dataset_name+"\\"+dataset_name+cur_time+"\\"
pos_name = "Tumor tissue"                       # the name of positive samples in the data set file
neg_name = "Normal tissue"                      # the name of negative samples in the data set file
