...
2. The selection process uses linear ranking selection rather than the roulette wheel selection for the former works much better than 
the latter in MGRFE according to experiments.
