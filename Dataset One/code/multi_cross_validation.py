...
to validate the classification performance of the selected gene combination on 17 binary data sets.
...
# data set information and selected genes of 17 datasets
datasets = [
...
output_path = "D:\\codes\\python\\MGRFE\\Dataset One\\results\\CV_RST\\"
...
# check the availability of output path
if not os.path.exists(output_path):
    os.mkdir(output_path)
out_file = open(output_stats, mode='w')


# calculate acc according to the confusion matrix
