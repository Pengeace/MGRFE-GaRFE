...
class APop(Population):
    def __init__(self, gene_len, potential_gene_rg, pop_size=100,
                 generation_size=10, pc=0.7, pm=0.3, best_size=5):
...
file_path = "D:\\codes\\python\\MachineLearning\\McTwo\\Colon.txt"
output_path = "D:\\codes\\python\\MachineLearning\\Python_Lesson\\ftselect\\populations_f\\" + dataset_name + "\\"
pos_name = "Tumor tissue"
neg_name = "Normal tissue"
ft_index_name = 'Genes'
...
feature_numbers_layer = [600,80,40]
rfe_feature_number_layer = [80,40,20]
