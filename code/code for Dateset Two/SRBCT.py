...
class RFE():
    ...
    def __init__(self, dataset, initial_ft_rg, cur_layer, rfe_num, file_path, max_gene_len,
                 cls_size, cls_names, index_name, pop_best_size=5, pop_size=100, best_size=30):
...
file_path = "D:\\codes\\python\\MachineLearning\\further_exp\\data\\SRBCT_whole.txt"
...
feature_numbers_layer = [1000,80,40]
rfe_feature_number_layer = [70,40,20]
